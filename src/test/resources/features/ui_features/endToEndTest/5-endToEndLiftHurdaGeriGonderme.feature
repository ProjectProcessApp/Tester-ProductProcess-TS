@endtoend
Feature: Talasli Imalat Amiri kendine gelen LIFT siparis turundeki gorevi baslatir ve Hurdaya, mil taslamaya ve isil isleme geri gonderebilir
  ...
  Scenario Outline: Kullanici Lift turunde yeni siparis olusturur
    ...
    Examples:
      ...
      |omer         |3000 ABC 300004|3000-A0004  |Lift          |1500              |100                |

  Scenario: Talasli Imalat Amiri kendine gelen LIFT siparis turundeki gorevi baslatir ve Hurdaya, mil taslamaya ve isil isleme geri gonderebilir
